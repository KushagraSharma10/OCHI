  ...
  return (
    <div className='w-full flex gap-5 h-screen bg-zinc-900 text-white p-20 font-["Founders_Grotesk"]'>
      ...
      <div className="w-1/2 h-full flex flex-col gap-4 ">
        ...
        <div className="font-['Neue_Montreal'] flex flex-col  gap-2 text-[1.2vw]">
          <h1 className="">S:</h1>
          <a href="">instagram</a>
          <a href="">Behance</a>
          <a href="">Facebook</a>
        ...
        <div className="font-['Neue_Montreal'] flex flex-col text-xl gap-2 pt-3 text-[1.2vw] ">
          <h1>L:</h1>
          <a href="">202-1965 W 4th Ave <br /> Vancouver, Canada</a>
          <a href="">30 Chukarina St <br />Lviv, Ukraine</a>
        </div>
        <div className="font-['Neue_Montreal'] flex flex-col text-xl gap-2 pt-2 text-[1.2vw] ">
          <h1>E:</h1>
          <a href="">http://hello@ochi.design</a>
        </div>
        <p className="text-zinc-500 text-[1.2vw]">© ochi design 2024. Legal Terms</p>
      </div>
    </div>
  );
};
